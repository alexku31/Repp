...
static char IP[] = { 58, 50, 42, 34, 26, 18, 10, 2,
...
static char PI[] = { 40, 8, 48, 16, 56, 24, 64, 32,
...
static char PC1[] = { 57, 49, 41, 33, 25, 17, 9,
    1, 58, 50, 42, 34, 26, 18,
    10, 2, 59, 51, 43, 35, 27,
    19, 11, 3, 60, 52, 44, 36,
...
static char PC2[] = { 14, 17, 11, 24, 1, 5,
    3, 28, 15, 6, 21, 10,
    23, 19, 12, 4, 26, 8,
    16, 7, 27, 20, 13, 2,
    41, 52, 31, 37, 47, 55,
...
uint64_t des(uint64_t input, uint64_t key, char mode)
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        for (j = 0; j < 8; j++)
        {
            ...
            s_output <<= 4;
            s_output |= (uint32_t)(S[j][16 *line + column] &0x0f);
        }
        f_function_res = 0;
...
void main(int argc, const char *argv[])
{
    ...
    uint64_t input = 0x111E8111;
    uint64_t key[3] = { 0x32DCF123, 0x22A654577, 0x22A66662C
    };
